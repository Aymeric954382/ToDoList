...
namespace ToDoList.Gateway.Application.Features.ToDoItem.Commands.Handlers.ChangeToDoPriority
{
    public class ChangeToDoPriorityCommand 
        : IWithResultCommand<ServiceResult<TaskStateServiceChangePriorityResponseDto>>, 
            IMapWith<TaskStateServiceChangePriorityRequestDto>
    {
        ...
        {
            profile.CreateMap<ChangeToDoPriorityCommand, TaskStateServiceChangePriorityRequestDto>();
        }
    }
}
